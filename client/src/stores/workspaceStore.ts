...
const INITIAL_ELEMENTS: WorkspaceElement[] = [
  ...
  },
  {
    ...
    strokeWidth: 0,
    cornerRadius: 0,
    text: "Unit Testing for Inclusive Design",
    fontSize: 32,
    fontFamily: "Fraunces",
    fontWeight: 700,
    textAlign: "left",
  ...
  },
  {
    ...
    strokeWidth: 0,
    cornerRadius: 0,
    text: "Evaluating interfaces against diverse virtual human profiles: motor constraints, low vision, and keyboard-only journeys.",
    fontSize: 13,
    fontFamily: "Manrope",
    fontWeight: 500,
    textAlign: "left",
  ...
  },
  {
    ...
    strokeWidth: 0,
    cornerRadius: 0,
    text: "Verifies interactive touch targets meet the 48x48px standard with tremor simulation.",
    fontSize: 11,
    fontFamily: "Manrope",
    fontWeight: 500,
    textAlign: "left",
